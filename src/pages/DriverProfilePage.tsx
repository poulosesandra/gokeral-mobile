...
import type { TabKey as SidebarTabKey } from "../components/profile/UserProfile";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-gray-100">
      ...
      <div className="flex relative w-full pl-0 pr-10">
        ...
        <UserSidebar
          userData={userData}
          activeTab={activeTab as unknown as SidebarTabKey}
          handleTabChange={(key: SidebarTabKey) => handleTabChange(key as TabKey)}
          handleLogout={handleLogout}
